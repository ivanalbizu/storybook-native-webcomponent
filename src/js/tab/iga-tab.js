  ...
  get style() {
    return `
      ...
      :host .js-active-tab-bg {
        ...
        left: 0;
        height: 100%;
        transition: width var(--trans-dur, .3s) linear var(--trans-del, 0.1s), height var(--trans-dur, .3s) linear var(--trans-del, 0.1s),
          transform var(--trans-dur, .3s) ease-out var(--trans-del, 0.1s);
